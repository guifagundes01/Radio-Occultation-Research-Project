...
def train_hybrid_model(model_stage1, model_stage2, train_loader, val_loader, 
    ...
    model_dir = './data/fit_results/hybrid_model_correction_0.5'
    ...
    for epoch in range(num_epochs):
        ...
        for X_batch, y_batch, profiles_batch, altitude_batch in train_loader:
            ...
            try:
                ...
                # Generate corrections
                corrections = model_stage2(X_batch, chapman_params.detach())
                ...
                # Calculate loss between corrected profiles and raw profiles
...
def main():
    ...
    test_metrics = evaluate_and_plot_test_results(
        model_stage1, model_stage2,
        test_loader, device,
        './data/fit_results/hybrid_model_correction_0.5'
    )
    ...
    print("Training completed! Model, scalers, and test results have been saved in the hybrid_model directory.")
    print("\nTest Metrics:")
