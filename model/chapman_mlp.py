...
class ChapmanMLP(nn.Module):
    def __init__(self, input_size=11, hidden_sizes=[128, 64], output_size=7):
        ...
        input_size : int
            ...
            - month_sin, month_cos, doy_sin, doy_cos, hour_sin, hour_cos (6)
            - f107, kp, dip (3)
        hidden_sizes : list
...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs=50, device='cuda'):
    ...
    model_dir = './data/fit_results/circular_encoding'
...
def main():
    ...
    model = ChapmanMLP(input_size=11, hidden_sizes=[128, 64])  # Updated input size
    ...
    print("Training completed! Model and scalers have been saved in the circular_encoding directory.")
